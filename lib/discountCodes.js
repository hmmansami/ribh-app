 ...
 */
async function createDiscountCode(storeId, customerEmail, discountPercent, expiresInHours = 48) {
    ...
    // TODO: Create code in Salla via API
    // await createSallaDiscountCode(storeId, code, discountPercent, expiresAt);
