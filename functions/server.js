...
// ==========================================
// 🚀 AUTO-ACTIVATION API ENDPOINTS (all auth-guarded)
// ==========================================

// Auth middleware for activation API — returns JSON 401 (not redirect)
...
app.post('/api/activation/toggle', requireStoreAuth, async (req, res) => {
    try {
